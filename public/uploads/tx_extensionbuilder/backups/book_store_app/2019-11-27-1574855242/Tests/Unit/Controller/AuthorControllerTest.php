...
{
    /**
     * @var \KunalHarkare\BookStoreApp\Controller\AuthorController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\KunalHarkare\BookStoreApp\Controller\AuthorController::class)
    ...
    public function listActionFetchesAllAuthorsFromRepositoryAndAssignsThemToView()
    {
        ...
        $authorRepository = $this->getMockBuilder(\KunalHarkare\BookStoreApp\Domain\Repository\AuthorRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();

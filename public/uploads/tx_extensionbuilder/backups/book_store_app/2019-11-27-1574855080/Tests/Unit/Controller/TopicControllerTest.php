...
{
    /**
     * @var \KunalHarkare\BookStoreApp\Controller\TopicController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\KunalHarkare\BookStoreApp\Controller\TopicController::class)
    ...
    public function listActionFetchesAllTopicsFromRepositoryAndAssignsThemToView()
    {
        ...
        $topicRepository = $this->getMockBuilder(\KunalHarkare\BookStoreApp\Domain\Repository\TopicRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();

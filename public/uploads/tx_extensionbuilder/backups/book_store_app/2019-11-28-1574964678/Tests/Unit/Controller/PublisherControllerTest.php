...
{
    /**
     * @var \KunalHarkare\BookStoreApp\Controller\PublisherController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\KunalHarkare\BookStoreApp\Controller\PublisherController::class)
    ...
    public function listActionFetchesAllPublishersFromRepositoryAndAssignsThemToView()
    {
        ...
        $publisherRepository = $this->getMockBuilder(\KunalHarkare\BookStoreApp\Domain\Repository\PublisherRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
